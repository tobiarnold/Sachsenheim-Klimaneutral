...
def main():
    ...
    df = pd.read_csv("https://github.com/tobiarnold/Sachsenheim-Klimaneutral/blob/main/output_file.txt",delimiter=";")
    df = df[df.STATIONS_ID != "STATIONS_ID"]
    df_station = pd.read_csv("https://github.com/tobiarnold/Sachsenheim-Klimaneutral/blob/main/KL_Jahreswerte_Beschreibung_Stationen.txt", encoding='latin-1', delimiter=";")
